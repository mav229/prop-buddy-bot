        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border/30 border border-border/30 rounded-2xl overflow-hidden">
            {features.map((feature, i) => (
              ...
              >
                <feature.icon className="w-5 h-5 text-muted-foreground mb-6 group-hover:text-foreground transition-colors duration-500" />
      ...
      <footer className="border-t border-border/20 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-xs text-muted-foreground">
            ...
            <a href="https://propscholar.com" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline">
              PropScholar
            </a>
          </span>
          <div className="flex items-center gap-6">
            ...
            <a href="https://propscholar.com" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
              PropScholar
            </a>
          </div>
        </div>
